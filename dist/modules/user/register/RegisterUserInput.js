...
const isEmailAlreadyExist_1 = require("./guards/isEmailAlreadyExist");
const PasswordInput_1 = require("../../shared/PasswordInput");
let RegisterUserInput = class RegisterUserInput extends PasswordInput_1.PasswordMixin(class {
}) {
};
__decorate([
...
__decorate([
    ...
    isEmailAlreadyExist_1.IsEmailAlreadyExist({ message: "The email is already in use!" }),
    __metadata("design:type", String)
