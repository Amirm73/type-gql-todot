...
let ForgotPasswordResolver = class ForgotPasswordResolver {
    forgotPassword(email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield redis_1.redis.set(redisPrefixies_1.forgotPasswordPrefix + token, user.id, "ex", 60 * 60 * 24);
            sendEmail_1.sendEmail(email, `http://localhost:3000/user/change-password/${token}`);
            return true;
        });
    }
};
